...
$consulta = $db->consulta("SELECT a.nombre as nombreusuario,a.bodega,b.nombre,a.clave,a.password, a.tipo as tipo FROM usuarios a, bodegas b WHERE a.clave='$usuario' AND a.Password='$password' AND b.numero=a.bodega");
